...
class SellFirstRegView extends StatefulWidget {
  const SellFirstRegView({Key? key}) : super(key: key);

  @override
  State<SellFirstRegView> createState() => _SellFirstRegViewState();
}

class _SellFirstRegViewState extends State<SellFirstRegView> {
                      ...
                      child: TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelStyle: TextStyle(
                              ...
                              color: AppColors.topHeaderBlueClr),
                          labelText:
                              'Enter your email address (hidden to public)*',
  ...
  Container signUpText() {
    var topHeaderBlueClr = AppColors.topHeaderBlueClr;
    return Container(
        margin: const EdgeInsets.only(
  ...
  Container nextButton(BuildContext context) {
    return Container(
      ...
      child: Obx(() => TextButton(
            ...
            onPressed: () {
              Get.toNamed(AppConstant.ROUTE_SELL_SEC_REG);
